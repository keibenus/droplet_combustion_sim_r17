...
NG = 16             # Number of gas grid points (cell centers)
...
T_END = 20e-3 # s (Simulation end time, 延長)
...
TURBULENCE_CONSTANT_PARAMS = {
    'k': 1.0,      # [m^2/s^2] 乱流エネルギー
    'epsilon': 100.0, # [m^2/s^3] 乱流散逸率
}
